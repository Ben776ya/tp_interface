...
//    im.lighten(.1);
//    im.writeToFile("image_lightened.png");

//    im.saturate(.1);
//    im.writeToFile("image_saturated.png");

//    im.rotateColor(90);
//    im.writeToFile("image_color_rotated.png");

//     Grayscale im1("res/euromed_image.png");
//     im1.writeToFile("grayscale_image.png");

//        Illini im("res/euromed_image.png");
//        im.writeToFile("illinified_image.png");

//    Spotlight im("res/euromed_image.png",150,100);
//    im.writeToFile("image_with_spotlight.png");
